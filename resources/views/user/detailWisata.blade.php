            ...
            <div class="col-lg-12">
                <div class="card card-chart">
                    <div class="card-header">
                        <h5 class="card-category">Profil Wisata {{$wisata->name}}</h5>
                        <div class="recent-report__chart">
                            <img src="{{asset('images/'.$wisata->gambar)}}">
                        </div>
                        <h4 class="card-title">{{$wisata->deskripsi}}</h4>
                    </div>
                    <div class="stats">
                        <i class="now-ui-icons location_world"> facebook : </i> <a
                            href="http://facebook.com/{{$wisata->facebook}}"><span>http://facebook.com/{{$wisata->facebook}}</span></a>
                        <br>
                        <i class="now-ui-icons location_world">twitter :</i> <a
                            href="http://twitter.com/{{$wisata->twitter}}">http://twitter.com/{{$wisata->twitter}}</a>
                        <br>
                        <i class="now-ui-icons location_world">instagram :</i> <a
                            href="http://instagram.com/{{$wisata->instagram}}">http://instagram.com/{{$wisata->instagram}}</a>
                    </div>
                    <div class="card-body">
