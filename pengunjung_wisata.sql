...
INSERT INTO `datapengunjung` (`id_dataPengunjung`, `jumlah_dataPengunjung`, `tanggal_dataPengunjung`, `id_negara`, `id_kabupaten`, `id_pengunjung`, `id_user`) VALUES
(9, 99, '2019-10-28', 102, '3512', 1, 13),
(10, 111, '2019-10-28', 13, NULL, 2, 13),
(11, 5, '2019-10-28', 2, NULL, 2, 13),
(12, 12, '2019-10-28', 102, '1505', 1, 14),
(13, 33, '2019-10-28', 1, NULL, 2, 14);
...
CREATE TABLE `negara` (
  `id` int(11) NOT NULL,
  `negara_kode` varchar(2) NOT NULL DEFAULT '',
  `negara_nama` varchar(100) NOT NULL DEFAULT ''
...
INSERT INTO `negara` (`id`, `negara_kode`, `negara_nama`) VALUES
(1, 'AF', 'Afghanistan'),
(2, 'AL', 'Albania'),
(3, 'DZ', 'Algeria'),
(4, 'DS', 'American Samoa'),
...
CREATE TABLE `pengunjung` (
  `id_pengunjung` int(11) NOT NULL,
  `status_pengunjung` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pengunjung` (`id_pengunjung`, `status_pengunjung`) VALUES
(1, 'domestik'),
(2, 'mancanegara');
...
INSERT INTO `provinces` (`id`, `name`, `id_negara`) VALUES
('11', 'ACEH', 102),
('12', 'SUMATERA UTARA', 102),
('13', 'SUMATERA BARAT', 102),
('14', 'RIAU', 102),
('15', 'JAMBI', 102),
('16', 'SUMATERA SELATAN', 102),
('17', 'BENGKULU', 102),
('18', 'LAMPUNG', 102),
('19', 'KEPULAUAN BANGKA BELITUNG', 102),
('21', 'KEPULAUAN RIAU', 102),
('31', 'DKI JAKARTA', 102),
('32', 'JAWA BARAT', 102),
('33', 'JAWA TENGAH', 102),
('34', 'DI YOGYAKARTA', 102),
('35', 'JAWA TIMUR', 102),
('36', 'BANTEN', 102),
('51', 'BALI', 102),
('52', 'NUSA TENGGARA BARAT', 102),
('53', 'NUSA TENGGARA TIMUR', 102),
('61', 'KALIMANTAN BARAT', 102),
('62', 'KALIMANTAN TENGAH', 102),
('63', 'KALIMANTAN SELATAN', 102),
('64', 'KALIMANTAN TIMUR', 102),
('65', 'KALIMANTAN UTARA', 102),
('71', 'SULAWESI UTARA', 102),
('72', 'SULAWESI TENGAH', 102),
('73', 'SULAWESI SELATAN', 102),
('74', 'SULAWESI TENGGARA', 102),
('75', 'GORONTALO', 102),
('76', 'SULAWESI BARAT', 102),
('81', 'MALUKU', 102),
('82', 'MALUKU UTARA', 102),
('91', 'PAPUA BARAT', 102),
('94', 'PAPUA', 102);
...
(13, 'pasir putih', 'razak.syaiful.r@gmail.com', 2, NULL, '$2y$10$FGKPDS2w7Sw/3cuMBgn7q.qPJqDtI.Ng7rbTI7o31seOdmwJcNQey', NULL, '2019-10-27 00:43:02', '2019-10-28 08:59:12'),
(14, 'Rembangan', 'rembangan@gmail.com', 2, NULL, '$2y$10$K1qDN2zGamp/XF8nIWuxdujUKBjXtIofLdy/9LQMzl2wXujcREZBC', NULL, '2019-10-27 06:47:34', '2019-10-27 06:47:34');
...
INSERT INTO `wisata` (`id_wisata`, `alamat`, `deskripsi`, `facebook`, `twitter`, `instagram`, `gambar`, `id_user`) VALUES
(5, 'asembagus', 'ini deskripsi', 'facebook', 'twitter', 'instagram', '394469277.jpg', 13),
(6, 'jember', 'ini rembangan', 'acek27', 'acek', 'acek27', '1340120096.jpg', 14);
...
--
ALTER TABLE `datapengunjung`
  MODIFY `id_dataPengunjung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- Constraints for table `datapengunjung`
--
ALTER TABLE `datapengunjung`
  ADD CONSTRAINT `datapengunjung_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `wisata`
  ADD CONSTRAINT `wisata_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
